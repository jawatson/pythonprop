...
class Sun:
    ...
    def computeGHA(self, T, M, J, STD):
        ...
        * to 360 degrees.
        * Copied from the version of sun.py on the mclock website with explanatory 
        * notes from http://www.koders.com/java/fid80310C2FCBC90DDAC99B5D6B4EFFF6B341A988E8.aspx
        """
